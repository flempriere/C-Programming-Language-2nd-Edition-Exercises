...
#### [v1](./Examples/Power/v1/power.c).
#### [v2](./Examples/Power/v2/power_v2.c)
...
*Print the Temperature Conversion Table in reverse order, i.e. from 300 to 0 degrees.*
...
*Copy the input to output, replacing strings of blanks by a single blank*

### [Ex 1-10](./Exercises/Ex1_10/ex1-10.c) 
*Copy input to output, replacing tabs with `\t`, each backspace `\b` and each backslash
by `\\`.*

### [Ex 1-11](./Exercises/Ex1-11/)
...
### [Ex 1-12](./Exercises/Ex1-12/ex1-12.c)
...
*Print a histogram of word lengths in input (vertically)*

#### [Ex 1-14](./Exercises/Ex1_14/ex1-14.c)
*Print a histogram of the frequencies of characters in the input*

**Note:** To avoid tediously manually filtering out printable characters, for now we restrict ourselves to assuming an ascii representation, where the printable characters are then indexed by the numbers $`33`$ through to $`126`$.
...
See the relevant example, [Hello World](#hello-world).
...
**Note** An alternative mechanism is provided by `constexpr` in the C23 standard. An variable declaration of the form,
```
...
See [Ex1.8](#ex-1-8), [Ex1.9](#ex1-9) and [Ex1.10](#ex1-10).
...
### Example [`power(m, n)`](#example-powerm-n). 
...
### Example [power_v2](#example-power_v2)
