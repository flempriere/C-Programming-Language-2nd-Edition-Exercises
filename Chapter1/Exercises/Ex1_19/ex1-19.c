 ...
 * @brief Solution to Exercise 1.19 from The C Programming Language, 2nd Edition.
 *
 ...
 * is performed inplace and the length of the reversed
 * string is returned.
 * 
 * @param len length of the string to be reversed.
 * @param s buffer storing the string.
 * @return int length of the reversed string.
 */
int reverse(int length, char s[length]);
...
int reverse(int len, char s[len]) {
    int i = 0;
